...
ActiveRecord::Schema.define(version: 20150309223520) do
  ...
  add_index "downloads", ["link_id"], name: "index_downloads_on_link_id", using: :btree
  ...
  create_table "links", force: :cascade do |t|
    ...
    t.integer  "trustlevel", limit: 4
    t.integer  "version_id", limit: 4
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
  end

  add_index "links", ["version_id"], name: "index_links_on_version_id", using: :btree
